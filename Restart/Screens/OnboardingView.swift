...
struct OnboardingView: View {
    ...
    @State
    private var buttonOffset: CGFloat = .zero
    
    @State
    private var isAnimating: Bool = false
    
    @State
    private var imageOffset: CGSize = .zero
    
    @State
    private var indicatorOpacity: Double = 1
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                ZStack {
                    CircleGroupView(ShapeColor: .white, ShapeOpacity: 0.2) //: CircleGroupView
